...
export default class CreateCaregiver extends Component {
    constructor(props) {
        super(props);
    ...
    saveCaregiver() {
        ...
        CaregiverService.createCaregiver(data)
            .then(response => {
                this.setState({
                    id: response.data.id,
            ...
            <div className="submit-form">
                {this.state.submitted ? (
                    <div>
                        ...
                        <button className="btn btn-success" onClick={this.newCaregiver}>
                            Add
                        </button>
                        <Link to={'/caregivers'}>
                    ...
                    <div>
                        ...
                        <button onClick={this.saveCaregiver} className="btn btn-success">
                            Submit
                        </button>
                    </div>
                )}
